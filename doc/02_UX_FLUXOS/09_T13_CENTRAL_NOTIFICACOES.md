...
Acessado pelo 🔔 no header · Lista cronológica única · 4 tipos · Push via AWS SNS Mobile Push
...
Dev: Push via AWS SNS Mobile Push, com credenciais APNs/FCM gerenciadas na AWS. Token de push armazenado no backend vinculado ao usuário — renovado a cada login.
...
<body>
  ...
  <div class="info-section">
    ...
    <div style="display:flex; flex-wrap:wrap; gap:8px;">
      ...
      <div style="background:#1a1a1a; border:1px solid #2a2a2a; border-radius:20px; padding:6px 12px; font-size:10px; color:#555;">Push via AWS SNS Mobile Push</div>
