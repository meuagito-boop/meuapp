...
| Raio de busca | Sim | Sim | Nao fica mais visivel pelo menu de Settings apos EXECUCAO-013 | Sem dado real; sem fake | Nao | Valores fixos removidos | Fora do release ate backend existir | `RootNavigator.tsx:87`, `SettingsAuxScreens.tsx`; criar preferencia real antes de reexibir |
| Preferencias de notificacoes | Sim | Sim | Nao fica mais visivel pelo menu de Settings apos EXECUCAO-013 | Sem dado real; sem fake | Nao | Switches fixos removidos | Fora do release ate backend existir | `RootNavigator.tsx:88`, `SettingsAuxScreens.tsx`; criar preferencias reais antes de reexibir |
| Usuarios bloqueados | Sim | Sim | Nao fica mais visivel apos EXECUCAO-012 | Sem dado real; sem fake | Nao | Lista vazia fake removida | Fora do release ate backend existir | `RootNavigator.tsx:90`, `SettingsAuxScreens.tsx`; criar bloqueios reais antes de reexibir |
...
| Dispositivos | Sim | Sim | Nao fica mais visivel pelo menu de Seguranca apos EXECUCAO-011 | Sem dado real; sem fake | Nao | Dados inventados removidos | Fora do release ate backend existir | `RootNavigator.tsx:94`, `SettingsAuxScreens.tsx`; criar sessoes reais antes de reexibir |
| Historico de acessos | Sim | Sim | Nao fica mais visivel pelo menu de Seguranca apos EXECUCAO-011 | Sem dado real; sem fake | Nao | Dados inventados removidos | Fora do release ate backend existir | `RootNavigator.tsx:95`, `SettingsAuxScreens.tsx`; criar audit log/sessoes reais antes de reexibir |
| Idioma | Sim | Sim | Nao fica mais visivel pelo menu de Settings apos EXECUCAO-013 | Sem dado real; sem fake | Nao | Idiomas fixos removidos | Fora do release ate backend existir | `RootNavigator.tsx:96`, `SettingsAuxScreens.tsx`; criar preferencia real antes de reexibir |
...
| `frontend/src/screens/main/SettingsAuxScreens.tsx` | Contas vinculadas, raio, notificacoes, idioma | Interagir com linhas/switches | Fora do caminho visivel; sem fake no codigo local | EXECUCAO-013 removeu entradas do menu e opcoes fixas nas telas auxiliares | `SettingsScreen.tsx`; `SettingsAuxScreens.tsx` | Implementar contratos reais antes de reexibir |
