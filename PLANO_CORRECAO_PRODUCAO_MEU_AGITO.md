...
- Telas criadas visualmente mas sem backend real suficiente: Atividade, Favoritos, Historico, Raio de busca, Preferencias de notificacoes, Idioma. `Minha conta` saiu desta lista no codigo local pela EXECUCAO-004, `PersonalSetup` saiu pela EXECUCAO-009, `Cidade` saiu pela EXECUCAO-010, `Seguranca/Alterar senha` saiu parcialmente pela EXECUCAO-011 e `Privacidade/Bloqueados` saiu do caminho visivel pela EXECUCAO-012.
...
| P1 | `frontend/src/screens/main/SettingsAuxScreens.tsx:102-154`, `188-210` | Contas vinculadas, raio, preferencias de notificacao e idioma continuam linhas estaticas/switches disabled; alterar senha foi RESOLVIDO pela EXECUCAO-011 e bloqueados saiu do caminho visivel pela EXECUCAO-012 | Nao para telas de configuracao acionaveis | Estado real das preferencias e provedores vinculados | Notificacoes: `notificationsService`; demais exigem endpoints de preferencias | Usuario altera nada apesar da UI parecer area de conta real; suporte e privacidade ficam inconsistentes |
